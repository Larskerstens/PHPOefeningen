...
//model classes
require_once $_SERVER['DOCUMENT_ROOT'] . "/PHP/PHP2Oefeningen/02_start/models/Fruit.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/PHP/PHP2Oefeningen/02_start/models/Aardbei.php";
